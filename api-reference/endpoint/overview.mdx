...
<Tip>More features are coming in the Beta version. Sign up to the [waitlist](/api-reference/auth/overview) to get notified.</Tip>

### Good to know
- BaseURL of the API is https://instant-rest-api-worker.cacevo.workers.dev/api/
